...
export type StrategyAPIEventArgs = StrategyAPIHarvestedEventArgs;

export enum StrategyAPIEvents {
  Harvested = "Harvested",
}

export interface StrategyAPIHarvestedEventArgs extends DecodedLogArgs {
  profit: BigNumber;
}
...
export class StrategyAPIContract extends BaseContract {
  /**
   * @ignore
   */
  public static deployedBytecode: string | undefined;
  public static contractName = "StrategyAPI";
  private readonly _methodABIIndex: { [name: string]: number } = {};
  private readonly _subscriptionManager: SubscriptionManager<
    StrategyAPIEventArgs,
    StrategyAPIEvents
  >;
  public static async deployFrom0xArtifactAsync(
    ...
    return StrategyAPIContract.deployAsync(
      bytecode,
      abi,
      provider,
      txDefaults,
  ...
  public static async deployWithLibrariesFrom0xArtifactAsync(
    ...
    const libraryAddresses = await StrategyAPIContract._deployLibrariesAsync(
      artifact,
      libraryArtifacts,
  ...
  public static async deployAsync(
    ...
    logUtils.log(
      `StrategyAPI successfully deployed at ${txReceipt.contractAddress}`
    );
    const contractInstance = new StrategyAPIContract(
    ...
    for (const link of Object.values(links)) {
      for (const libraryName of Object.keys(link)) {
        if (!libraryAddresses[libraryName]) {
          ...
          await StrategyAPIContract._deployLibrariesAsync(
            libraryArtifact,
            libraryArtifacts,
            web3Wrapper,
            txDefaults,
  ...
  public getFunctionSignature(methodName: string): string {
    ...
    const methodAbi = StrategyAPIContract.ABI()[index] as MethodAbi; // tslint:disable-line:no-unnecessary-type-assertion
  ...
  public getABIDecodedTransactionData<T>(
    ...
    const self = (this as any) as StrategyAPIContract;
  ...
  /**
   * Subscribe to an event type emitted by the StrategyAPI contract.
   * @param eventName The StrategyAPI contract event you would like to subscribe to.
   ...
   */
  public subscribe<ArgsType extends StrategyAPIEventArgs>(
    eventName: StrategyAPIEvents,
    indexFilterValues: IndexedFilterValues,
    callback: EventCallback<ArgsType>,
    isVerbose: boolean = false,
    blockPollingIntervalMs?: number
  ): string {
    assert.doesBelongToStringEnum("eventName", eventName, StrategyAPIEvents);
   ...
   */
  public async getLogsAsync<ArgsType extends StrategyAPIEventArgs>(
    eventName: StrategyAPIEvents,
  ...
  constructor(
    ...
    txDefaults?: Partial<TxData>,
    logDecodeDependencies?: { [contractName: string]: ContractAbi },
    deployedBytecode: string | undefined = StrategyAPIContract.deployedBytecode
  ) {
    super(
      "StrategyAPI",
      StrategyAPIContract.ABI(),
    ...
    this._subscriptionManager = new SubscriptionManager<
      StrategyAPIEventArgs,
      StrategyAPIEvents
    >(StrategyAPIContract.ABI(), this._web3Wrapper);
    StrategyAPIContract.ABI().forEach((item, index) => {
